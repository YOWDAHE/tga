...
import { generateRefreshToken, generateToken, JwtPayload, verifyRefreshToken } from '../middlewares/jwtAuth';
...
export async function signUp(req: Request, res: Response) {
    ...
    const { username, email, phone_number, password, roles } = req.body;
