...
import { AppShell, Burger, Group, Title, NavLink, Text, rem, Menu, Avatar, Button } from "@mantine/core"
  ...
  return (
    ...
    >
      ...
      <AppShell.Navbar p="lg" style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ marginTop: "auto", paddingTop: "1rem", borderTop: "1px solid #e9ecef" }}>
          <NavLink
