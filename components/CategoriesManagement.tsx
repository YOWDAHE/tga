...
export default function CategoriesManagement({
	...
	const [categories, setCategories] = useState<Category[]>(
		initialCategories.map((cat) => ({
			...cat,
			createdAt:
				typeof cat.createdAt === "string" ? new Date(cat.createdAt) : cat.createdAt,
			updatedAt:
				typeof cat.updatedAt === "string" ? new Date(cat.updatedAt) : cat.updatedAt,
		}))
	);
	...
	const handleCreate = () => {
		...
		form.reset();
		open();
		console.log("handleCreate called: ", opened);
	};
	...
	return (
		<div style={{ padding: "24px" }}>
			...
			{categories.length === 0 && <Center style={{padding: 30}}>No Categories Available</Center>}
					...
					{pagination && pagination.totalPages > 1 && (
						<Group justify="end" mt="lg">
							<Button
								...
								leftSection={
									isLoading ? <Loader size="xs" /> : <IconChevronLeft size={16} />
								}
							>
								Previous
							</Button>
							...
							<Button
								...
								rightSection={
									isLoading ? <Loader size="xs" /> : <IconChevronRight size={16} />
								}
							>
								Next
							</Button>
					...
					<Stack>
						...
						<Group justify="flex-end">
							...
							<Button
								...
								leftSection={isSubmitting ? <Loader size="xs" /> : null}
							>
								{isSubmitting ?
									"Updating..."
								: editingCategory ?
